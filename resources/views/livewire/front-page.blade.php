<div>
    ...
    <div class="relative">
        ...
        <x-sections.services id="services" class="pt-20 lg:pt-64 relative" :services="$services" />
        <x-sections.testimonials class="pt-20 relative lg:pt-96" :testimonials="$testimonials" />
    </div>
    <x-sections.partners class="pt-20 lg:pt-48 max-w-[1600px] mx-auto text-center" :partners="$partners" />
</div>
