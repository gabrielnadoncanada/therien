...
<x-sections.site.contact class="mt-[229px] max-w-[1280px] bg-primary py-[96px] px-[122px] rounded-[500px] mx-auto  flex justify-between gap-x-[140px]"></x-sections.site.contact>
