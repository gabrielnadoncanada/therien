@php
	$testimonials = [
		[
            'title' => 'Julie Nathan',
			'description' => 'Votre travail est tout simplement incroyable. J’adore !',
			'rating' => 5,
		],
		[
            'title' => 'Julie Nathan',
...
>
	...
	<div x-ref="container" class="swiper-container overflow-hidden">
		<div class="swiper-wrapper flex gap-x-[30px]">
			  @foreach($testimonials as $index => $testimonial)
				<article
						class="swiper-slide mx-auto  aspect-[500/191] flex gap-x-[32px]   p-[40px] border border-primary rounded-[200px]">
