<section {{$attributes}}x-data="{swiper: null}" x-init="swiper = new Swiper($refs.container, {
     	width: 500,
      slidesPerView: 'auto',
      spaceBetween: 30,
    })"
>
 ...
 mx-auto flex gap-x-[67px]  items-center">
	...
	<div x-ref="container" class="overflow-hidden swiper-container absolute bottom-0 " style="left: calc((50% - 1600px / 2) + 60px + 80px);">
